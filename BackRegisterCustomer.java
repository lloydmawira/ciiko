 ...
 */
public class BackRegisterCustomer extends AsyncTask<String, String, String> {
    ...
    public BackRegisterCustomer(Context context){
    ...
    protected void onPostExecute(String Json) {
        try {
          ...
          if(code.equals("reg_true")){
              ...
              showDialog("Booking failed.....Try again",message,code);
          }
